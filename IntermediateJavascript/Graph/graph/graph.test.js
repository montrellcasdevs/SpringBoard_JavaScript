...
describe("addEdge", function() {
  it("should add the appropriate edges to the adjacency list", function() {
    ...
    graph.addEdge(b, d);
    graph.addEdge(c, d);
    expect(Array.from(a.adjacent)).toEqual(expect.arrayContaining([b, c]));
    expect(Array.from(b.adjacent)).toEqual(expect.arrayContaining([a, d]));
    expect(Array.from(c.adjacent)).toEqual(expect.arrayContaining([a, d]));
    expect(Array.from(d.adjacent)).toEqual(expect.arrayContaining([b, c]));
  });
});
...
describe("removeEdge", function() {
  it("should remove the vertices from the adjacency list", function() {
    ...
    expect(Array.from(a.adjacent)).not.toEqual(expect.arrayContaining([b]));
    expect(Array.from(c.adjacent)).not.toEqual(expect.arrayContaining([d]));
  });
});
